...
## Structured experiment-protocol authoring example

Experiment documentation should make the objective, materials, controls, safety conditions, and ordered procedure reproducible. The public wiki and its evidence trail should remain understandable, findable, and properly referenced [@igem-special-awards-2026].[^wet-lab-experiments-fixture]

The statement below links directly to the structured record: [[evidence:experiment-protocol-demo|Open this authoring example]].

```protocol
id: experiment-protocol-demo
title: Reproducible experiment protocol example
objective: Demonstrate structured documentation for a controlled assay.
version: "0.1-authoring-fixture"
date: 2026-08-23
materials:
  - Defined sample
  - Calibrated measurement instrument
  - Positive and negative controls
steps:
  - Record batch and instrument identifiers.
  - Prepare samples and controls using the same conditions.
  - Capture raw measurements before analysis.
controls:
  - Negative control
  - Positive control
safety:
  - Replace with the real organism, chemical, and disposal controls.
citations:
  - igem-team-wiki-2026
```
...
[^wet-lab-experiments-fixture]: This is an authoring fixture, not project evidence. Replace it with verified BASIS-China records, real citations, and measured data before judging.
