...
export const pageData = [
  ...
  },
  {
    ...
    title: "Parts",
    summary:
      "The parts we designed and built, documented on the iGEM Registry.",
    category: "project",
    kind: "markdown",
    contentPath: "articles/project/parts",
    navLabel: "Parts",
    navGroup: "project",
    showInNavbar: true,
    showInFooter: true,
    seo: {
      title: "Parts · BASIS-China 2026 iGEM",
      description:
        "BioBrick parts designed and characterized by the 2026 BASIS-China iGEM team, documented on the iGEM Registry.",
      keywords: ["parts", "registry", "biobricks", "iGEM", "BASIS-China"],
      ogType: "article",
    },
    sitemap: { priority: 0.7, changefreq: "monthly" },
  },
  ...
  },
  {
    ...
    summary: "How we worked with other iGEM teams and partners.",
    category: "human-practices",
    kind: "markdown",
    contentPath: "articles/engagement/collaborations",
    navLabel: "Collaborations",
    navGroup: "human-practices",
    showInNavbar: true,
    showInFooter: true,
    seo: {
      title: "Collaborations · BASIS-China 2026 iGEM",
      description:
        "Collaborations between the 2026 BASIS-China iGEM team and other teams and partners.",
      keywords: ["collaborations", "teamwork", "iGEM", "BASIS-China"],
      ogType: "article",
    },
    sitemap: { priority: 0.6, changefreq: "monthly" },
  },
