...
## Structured measurement-data authoring example

Measurement documentation should expose units, calibration context, replicate counts, and uncertainty alongside the values. The public wiki and its evidence trail should remain understandable, findable, and properly referenced [@igem-special-awards-2026].[^wet-lab-measurement-fixture]

The statement below links directly to the structured record: [[evidence:measurement-data-demo|Open this authoring example]].

```data-figure
id: measurement-data-demo
title: Measurement table authoring example
caption: Demonstration calibration values, authoring fixture only, with explicit units.
description: The table shows how measured values and uncertainty can remain available to assistive technology.
columns:
...
[^wet-lab-measurement-fixture]: This is an authoring fixture, not project evidence. Replace it with verified BASIS-China records, real citations, and measured data before judging.
