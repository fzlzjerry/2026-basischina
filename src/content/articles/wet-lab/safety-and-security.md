...
description: How BASIS-China identifies biological and lab risks, mitigates them, and communicates results responsibly throughout the project.
author: BASIS-China Team
date: 2026-05-01
tags: [safety, security, biosafety, lab, risk]
relatedPages:
  - /experiments
  - /human-practices
  - /plant
...
## Structured safety protocol authoring example

Safety documentation should connect hazards to controls, responsible procedures, and versioned review rather than list generic assurances. The public wiki and its evidence trail should remain understandable, findable, and properly referenced [@igem-special-awards-2026].[^wet-lab-safety-and-security-fixture]

The statement below links directly to the structured record: [[evidence:safety-protocol-demo|Open this authoring example]].

```protocol
id: safety-protocol-demo
title: Safety review protocol example
objective: Demonstrate a repeatable review for biological, chemical, environmental, and misuse risks.
version: "0.1-authoring-fixture"
date: 2026-08-23
materials:
  - Current protocol
  - Organism and chemical inventory
  - Applicable institutional guidance
steps:
  - Identify hazards and exposed groups.
  - Assign preventive and containment controls.
  - Record reviewer, decision, and next review date.
controls:
  - Supervisor review
  - Incident escalation path
safety:
  - This fixture is not a substitute for the team's approved safety documentation.
citations:
  - igem-team-wiki-2026
```
...
[^wet-lab-safety-and-security-fixture]: This is an authoring fixture, not project evidence. Replace it with verified BASIS-China records, real citations, and measured data before judging.
