---
title: Notebook
description: A chronological lab notebook tracking BASIS-China's experiments, decisions, and weekly progress throughout the 2026 iGEM season.
author: BASIS-China Team
date: 2026-05-01
tags: [notebook, wet-lab, timeline, protocols, iGEM]
relatedPages:
  - /experiments
  - /results
  - /engineering
...
## Structured notebook-timeline authoring example

Notebook entries should record what happened, what was learned, and what action followed, including unsuccessful work. The public wiki and its evidence trail should remain understandable, findable, and properly referenced [@igem-special-awards-2026].[^wet-lab-notebook-fixture]

The statement below links directly to the structured record: [[evidence:notebook-timeline-demo|Open this authoring example]].

```notebook-timeline
id: notebook-timeline-demo
title: Chronological notebook authoring example
entries:
  - id: notebook-entry-demo-01
    date: 2026-08-20
    workstream: wet-lab
    status: needs-repeat
    title: Demonstration assay entry
    outcome: The fixture records an inconclusive outcome instead of hiding it.
    next: Repeat with verified controls and additional biological replicates.
  - id: notebook-entry-demo-02
    date: 2026-08-23
    workstream: dry-lab
    status: completed
    title: Evidence schema reviewed
    outcome: Required fields and cross-links passed content validation.
    next: Replace fixtures with team records.
citations:
  - igem-team-wiki-2026
```
...
[^wet-lab-notebook-fixture]: This is an authoring fixture, not project evidence. Replace it with verified BASIS-China records, real citations, and measured data before judging.
