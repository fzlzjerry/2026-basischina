---
title: Contribution
description: A reusable, well-documented contribution from BASIS-China that helps future iGEM teams build faster on our parts, data, and protocols.
author: BASIS-China Team
date: 2026-05-01
tags: [contribution, parts, characterization, protocol, documentation]
relatedPages:
  - /parts
  - /experiments
  - /software
...
## Structured reusable-contribution authoring example

A contribution becomes reusable when another team can identify its inputs, procedure, controls, and version. The public wiki and its evidence trail should remain understandable, findable, and properly referenced [@igem-special-awards-2026].[^project-contribution-fixture]

The statement below links directly to the structured record: [[evidence:contribution-protocol-demo|Open this authoring example]].

```protocol
id: contribution-protocol-demo
title: Reusable contribution protocol example
objective: Demonstrate the minimum metadata needed for another team to repeat a contributed workflow.
version: "1.0"
date: 2026-08-23
materials:
  - Versioned source or biological material
  - Documented input data
steps:
  - State the starting conditions.
  - Follow numbered and testable steps.
  - Record deviations and outputs.
controls:
  - Retain a known-good reference workflow.
safety:
  - Replace this fixture with the real risk controls.
citations:
  - igem-team-wiki-2026
```
...
[^project-contribution-fixture]: This is an authoring fixture, not project evidence. Replace it with verified BASIS-China records, real citations, and measured data before judging.
